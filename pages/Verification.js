...
function Verification () {    
    const [loaded] = useFonts({
        Roboto_700Bold, Ubuntu_300Light, Ubuntu_500Medium
    });
        ...
        <View style={styles.container}>
            <View style={styles.items}> 
                ...
                <View style={styles.row}>
                    <Avatar.Image size={55}
                        source={{
                            uri: 'https://previews.123rf.com/images/rido/rido1204/rido120400047/13283722-happy-smiling-guy-showing-thumb-up-hand-sign-isolated-on-white-background.jpg',
                        }}
                    />
                    <View style={styles.column}>
